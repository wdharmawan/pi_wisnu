...
if (isset($_POST['daftar'])) {
    ...
    if (empty($nama) || empty($username) || empty($email) || empty($pass) || empty($nomer) || empty($alamat)) {
        ...
        // Execute the query
        $result = $koneksi->query("INSERT INTO data_pelanggan (nama_pel, username_pel, email_pel, pass_pel, nohp_pel, alamat_pel) 
        ...
        <div class="container-regis">
            ...
            <div class="content-regis">
                <form class="form-content" method="post">
                    ...
                    <div class="form-regis">
                        <p>Sudah punya akun ? <a class="link-regis" href="loginPeng.php">Login</a></p>
                    </div>
                </form>
